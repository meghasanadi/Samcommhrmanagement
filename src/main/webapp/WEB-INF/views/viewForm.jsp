        ...
        <div class="col-sm-8">
          ...
          <h3 class="mt-4">Role:${job.job_name}</h3>
            ...
            <tr>
                            ...
                            <hr>
								<a href="welcome?id=${job.jobid}" class="btn btn-info" role="button">Login to Apply</a>	   <a href="newuser" class="btn btn-info" style="background-color: #ace600;" role="button">Register and Apply</a>                         
                           	<hr>
        </div>
        <div class="col-sm-4">
