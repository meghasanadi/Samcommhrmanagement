        ...
        <div class="col-md-6">
			...
			<%-- <div class="row">
				<div class="form-group col-md-12">
					...
					<div class="col-md-7">
						<form:input type="text" value="USER" path="" class="form-control input-sm" />
						<div class="has-error">
							<form:errors path="email" class="help-inline"/>
						</div>
					</div>
			 ...
			 <div class="row">
				<div class="form-group col-md-12">
					...
					<div class="col-md-7">
					<form:input path="userProfiles" items="${roles}" multiple="true" itemValue="id" itemLabel="type" class="form-control input-sm" disabled="true"/> 
